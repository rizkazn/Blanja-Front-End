...
class Login extends Component {
    ...
    getData = (token) => {
        axios({
            method: "GET",
            url: `${process.env.REACT_APP_API}/sellers/${this.state.email}`,
            headers: {
                tokenauth: token,
            },
        })
    ...
    SubmitHandler = async () => {
        try {
            ...
            const res = await axios.post(`${process.env.REACT_APP_API}/auth/seller`, body, { 'Content-type': 'application/x-www-form-urlencoded', });
            console.log(res)
        ...
        return (
          <div className="container">
            ...
            <p className="nohave-acc">
              ...
              <Link to="/regist-seller">Register</Link>
            </p>
          </div>
        );
    }  
